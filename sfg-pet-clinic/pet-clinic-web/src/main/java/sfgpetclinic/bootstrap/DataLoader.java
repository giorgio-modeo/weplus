...
public class DataLoader implements CommandLineRunner {
    ...
    @Autowired
    public DataLoader(OwnerService ownerService, VetService vetService, PetTypeService petType, SpecialityService specialityService, VisitService visitService) {
